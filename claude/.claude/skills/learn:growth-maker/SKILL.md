...
- **팀 기조 반영**: 안정성 > 비용 > 가용성 수준 가중치, Engineering over Money 지향
...
1. 분석 전에 Socratic 자기 인식 질문 3개를 제시하여 사용자가 스스로 성장 방향을 탐색하게 한다
2. 도메인 지식 맵에서 연관 주제를 찾아 우선순위 결정
3. 아래 형식으로 출력

### Socratic 자기 인식 질문 (분석 전 필수)
...
|------|------|------------|---------|--------------|
| 1 | {주제} | {구체적 연결} | 안정성/비용/가용성 수준 | `/learn {topic}` |
| 2 | ... | ... | ... | ... |
...
3. (Step 2.5) Socratic 방향 확인: 러닝 패스를 설계하기 전, 사용자의 의도를 구체화한다
4. 도메인 지식 맵에서 의존성 관계 도출 → Phase 설계

### Step 2.5: Socratic 방향 확인 질문
...
- [ ] 추천 근거가 팀 기조(안정성/비용/가용성 수준/엔지니어링)에 연결됨
