...
| Obsidian `today` → `todos.completed` | **오늘 한 일 유일한 기준** — Transcript 보완 없음 |
...
| Transcript `sessions` | KPT·Growth Feedback 보완용 — **오늘 한 일 요약에는 미포함** |
...
**Transcript 해석 방법 (KPT·Growth Feedback 보완용):**
...
**Empty state:** Step 1에서 완료 작업(`todos.completed` + Transcript 추가 완료)이 0건이면
...
- **오늘 한 일 요약은 Obsidian `todos.completed`만 사용한다** — Transcript를 추가 완료 항목으로 포함하지 않는다. Transcript는 KPT·Growth Feedback 보완에만 사용
